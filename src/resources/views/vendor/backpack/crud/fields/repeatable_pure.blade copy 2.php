  ...
  @push('crud_fields_scripts')
      <script>
        ...
        function repeatableInputToObj(container_name) {
            ...
            var escapedName = CSS.escape(container_name);
            var container = $('[data-repeatable-holder="'+escapedName+'"]');

            container.children('[data-repeatable-identifier="'+escapedName+'"]').each(function () {
        ...
        function bpFieldInitRepeatableElement(element) {
            ...
            getRepeatableInputsForElement(container)
                    .each(function(){
                        if ($(this).data('name')) {
